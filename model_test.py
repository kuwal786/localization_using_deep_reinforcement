...
from pre_trained_cnn import get_image_descriptor_for_image, obtain_compiled_vgg_16, vgg_16, \
    get_conv_image_descriptor_for_image, calculate_all_initial_feature_maps
from all_helper_functions import *
from deep_q_n import *
...
if __name__ == "__main__":
    ...
    model_name = "model_image_zooms_2"
    # path of folder where the weights are
    weights_path = "./model_image_zooms/"
